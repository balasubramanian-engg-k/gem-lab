...
<input type="hidden" name="cert_no" id="cert_no" value="{{ $gem->summary_no }}">
...
<div id="certificate-container" class="relative flex flex-col items-center">
    ...
    <div id="certificate" class="bg-white w-[700px]  shadow-lg overflow-hidden rounded-xl ">
        ...
        <div class="text-white flex items-center justify-between px-4 py-2">
            ...
            <div class="flex items-center max-h-20 px-2 qr-adjustment">$gem->summary_no
                {!! QrCode::size(95)->generate('https://report.ghcgemlab.com/search_certificate/'.$gem->summary_no) !!}
            </div>
        </div>
    ...
    html2canvas(document.querySelector("#certificate"), {
        ...
        fetch("/gems/save-certificate", {
            ...
            body: JSON.stringify({
                ...
                filename: document.querySelector("#cert_no").value + '.png',
                cert_no: document.querySelector("#cert_no").value
            })
        })
        ...
        .then(blob => {
            ...
            // link.download = document.querySelector("#cert_no").value  + ".png";
            // link.click();
        });
