...
<div id="certificate-container" class="relative flex flex-col items-center">
    ...
    <div id="certificate" class="bg-white w-[700px]  shadow-lg overflow-hidden rounded-xl">
        ...
        <div class="px-4">
            <div class="flex items-center justify-center mb-1 mt-1 header-adjustment">
                ...
                <span class="px-4 font-bold text-sm text-[#6E5C4D] header-text">IDENTIFICATION REPORT</span>
                ...
                <div class="flex pb-4">
                    <div class="w-full text-sm space-y-2">
                        ...
                        @foreach ($gemDetails as $label => $value)
                            <div class="flex">
                                <span class="w-44 font-medium">{{ $label }}</span>
    ...
    <span class="block -rotate-90 whitespace-nowrap origin-bottom-right terms-adjustment">Terms & Conditions Apply</span>
</div>
                    </div>
                </div>
                <div class="flex pb-4">
                    <div class="w-full text-sm space-y-2">
                        ...
                        @foreach ($gemDetails as $label => $value)
                            <div class="flex">
                                <span class="w-44 font-semibold">{{ $label }}</span>
