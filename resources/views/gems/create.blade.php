...
<div class="max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-md mt-10">
    <h1 class="text-2xl font-bold mb-6 text-gray-800">Add New Gem</h1>
    ...
    <form action="{{ route('gems.store') }}" method="POST" enctype="multipart/form-data" class="space-y-5">
        @csrf
    <div>
        <label class="block font-medium text-gray-700 mb-2">Type</label>
        <div class="flex items-center space-x-6">
            <label class="inline-flex items-center">
                <input type="radio" checked='checked' name="type" id="type_gem" value="One Silver Ring Studded with Gemstone"
                    {{ old('type') == 'One Silver Ring Studded with Gemstone' ? 'checked' : '' }}
        ...
        <div>
            ...
            <textarea required name="description" maxlength="115"  oninput="updateCharCount(this)" id="description" rows="3"
                      class="mt-1 block w-full border border-gray-300 rounded-lg shadow-sm p-2 focus:ring-blue-500 focus:border-blue-500">One Silver Ring Studded with Gemstone</textarea>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 relative">
             <div>
                ...
                <div class="flex items-center space-x-4 mt-2">
                    <label class="inline-flex items-center">
                        <input type="radio" name="clarity_type" value="AA" class="clarity-radio text-blue-600" checked>
                        <span class="ml-2 text-gray-700">AA</span>
                    </label>
                    <label class="inline-flex items-center">
                        <input type="radio" name="clarity_type" value="Others" class="clarity-radio text-blue-600">
                        <span class="ml-2 text-gray-700">Others</span>
                    </label>
                </div>
                <div id="clarity_other_div" class="mt-2 hidden">
            ...
            <div>
                ...
                <div class="flex items-center space-x-4 mb-2">
                    <label class="inline-flex items-center">
                        <input type="radio" name="weight_type" id="weight_type_gross" value="gross_weight" class="weight-type-radio text-blue-600" 
                               {{ old('weight_type', 'gross_weight') == 'gross_weight' ? 'checked' : 'checked' }}>
                    ...
                    <label class="inline-flex items-center">
                        <input type="radio" name="weight_type" id="weight_type_hardness" value="hardness" class="weight-type-radio text-blue-600"
                               {{ old('weight_type') == 'hardness' ? 'checked' : '' }}>
                ...
                <div id="hardness_div" class="hidden">
        ...
        <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-2">
                ...
                @foreach ($stones as $stone)
                    <label class="inline-flex items-center">
                        <input type="radio" name="comment_type" value="{{ $stone }}"
        ...
        <div>
            ...
            <textarea required name="comment" maxlength="60" id="comment" rows="3"
                      class="mt-1 block w-full border border-gray-300 rounded-lg shadow-sm p-2 focus:ring-blue-500 focus:border-blue-500" oninput="updateCommentCharacterCount(this)" >RUBY</textarea>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function toggleWeightFields() {
            const selectedWeightType = document.querySelector('.weight-type-radio:checked').value;
            
            if (selectedWeightType === 'gross_weight') {
            ...
            } else if (selectedWeightType === 'hardness') {
